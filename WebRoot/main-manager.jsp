		...
		<div class="container-fluid" style="padding: 0;">
			<div class="row"
				...
				<ul class="nav nav-pills nav-stacked" style="text-align: center;">
					...
					<li class="dropdown"><a href="javascript:open2();"> 反馈信息 <span
							class="caret"></span>
					</a>
						<ul class="nav nav-pills nav-stacked open-menu" id="menu_2"
							style="text-align: center;" hidden>
							<li><a href="#">系统问题反馈</a></li>
							<li><a href="#">申请更改课程信息</a></li>
							<li><a href="#">学生成绩申诉</a></li>
						</ul></li>
					<li><a href="#">退出管理员</a></li>
				</ul>
				<div
					style="width: 95%;padding: 6px;border: 1px solid #ccc;text-align: center;margin-top: 20px;margin-left: 8px;">
					<p>咨询QQ：2923471252</p>
					<p>
				...
				<div class="col-md-10 breadcrumbs"
					...
					<ul class="breadcrumb"
						style="height: 100%;line-height: 23.2px;background-color: #F5F5F5;">
				...
				<div class="col-md-10"
					style="padding-right: 0;border: 1px solid #ccc;border-top: 0;">
					<ul class="nav nav-pills nav-stacked" style="margin-top: 10px;">
						<!--<li class="active"><a href="#">通知公告</a></li>-->
						<ul id="gonggao" style="width: 95%;padding-top: 10px;">
							<li><a href="#"> <text>华信软件学院2015级选课系统</text> <text>2018-4-10</text>
							</a></li>
							<li><a href="#"> <text>华信软件学院2015级选课系统</text> <text>2018-4-10</text>
							</a></li>
							<li><a href="#"> <text>华信软件学院2015级选课系统</text> <text>2018-4-10</text>
