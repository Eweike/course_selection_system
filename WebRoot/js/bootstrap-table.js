    ...
    BootstrapTable.prototype.initPagination = function () {
        ...
        if (!this.options.onlyInfoPagination) {
            ...
            html.push('</div>',
                ...
                sprintf('<li class="page-item page-pre"><a class="page-link" href="javascript:changeTable();">上一页</a></li>',
            ...
            if (this.totalPages >= 6) {
                if (this.options.pageNumber >= 3) {
                    html.push(
                        ...
                        '<a class="page-link" href="javascript:changeTable();">', 1, '</a>',
                        '</li>');
                ...
                if (this.options.pageNumber >= 4) {
                    if (this.options.pageNumber == 4 || this.totalPages == 6 || this.totalPages == 7) {
                        ...
                        html.push('<li class="page-item page-first-separator disabled">',
                            '<a class="page-link" href="javascript:changeTable();">...</a>',
                            '</li>');
                    }
            ...
            for (i = from; i <= to; i++) {
                html.push(sprintf('<li class="page-item%s">',
                    ...
                    '<a class="page-link" href="javascript:changeTable();">', i, '</a>',
                    '</li>');
            }
            ...
            if (this.totalPages >= 6) {
                if (this.options.pageNumber <= (this.totalPages - 3)) {
                    html.push(sprintf('<li class="page-item page-last%s">',
                        ...
                        '<a class="page-link" href="javascript:changeTable();">', this.totalPages, '</a>',
                        '</li>');
                }
            }

            html.push(
                sprintf('<li class="page-item page-next"><a class="page-link" href="javascript:changeTable();">下一页</a></li>',
